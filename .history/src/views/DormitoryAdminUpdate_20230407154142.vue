...
// import { log } from 'console';
    ...
    export default {
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        axios.post('http://localhost:8181/dManager/update',_this.ruleForm).then(function (resp) {
                            if(resp.data.code == 0){
        ...
        created() {
            const _this = this
            axios.get('http://localhost:8181/dManager/findById/'+_this.$route.query.id).then(function (resp) {
