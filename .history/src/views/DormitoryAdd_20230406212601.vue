  ...
  >
    ...
    >
      ...
      <el-form-item label="宿舍类型" prop="type">
        <el-select v-model="ruleForm.type" placeholder="请选择宿管类型">
          <el-option label="四人间" value="shanghai"></el-option>
          <el-option label="六人间" value="beijing"></el-option>
          <el-option label="ba人间" value="beijing"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item>
