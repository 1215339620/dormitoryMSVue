<template>
    <div style=";margin-left:330px;width: 300px;height: 500px;border: 0px solid red;" >
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="宿舍楼" prop="bId">
                <el-select v-model="ruleForm.bId" placeholder="请选择宿舍楼">
                    <el-option v-for="item in bList" :label="item.name" :value="item.id"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item label="宿舍" prop="dId">
                <el-select v-model="ruleForm.dId" placeholder="请选择宿舍">
                    <el-option v-for="item in dList" :label="item.name" :value="item.id"></el-option>
                </el-select>
            </el-form-item>
            <el-form-item>
