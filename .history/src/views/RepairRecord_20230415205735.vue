    ...
    <div style="margin-top: 60px;margin-left:80px;border: 0px solid red;" >
        ...
        <el-table
            ...
            <el-table-column label="操作" align="center"  width="200">
                <template slot-scope="scope" v-if="tableData[scope.row.id-1].status==0">
                    <el-button
                            size="mini"
                            type="warning"
                ...
                <template slot-scope="scope" v-if="tableData[scope.row.id-1].status==1">
                    <el-button
                            size="mini"
                            type="warning"
                            @click="edit(scope.row)"
                ...
                <template slot-scope="scope" v-if="tableData[scope.row.id-1].status==2">
                    <el-button
                            size="mini"
                            type="warning"
                            @click="edit(scope.row)"
