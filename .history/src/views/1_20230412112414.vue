<template>
  <div>
    ...
    <br />
    类型: <input type="text" id="type" /> 内容:
    <input type="text" id="text" /> 字体大小:
    <input type="text" id="font" /> 背景颜色: <input type="text" id="color" />

    <button style="margin-left: 10px" id="add" on-click="add">增加</button>
  </div>
</template>
