<template>
    <div class="login-container">
        <el-form :model="ruleForm" :rules="rules"
            ...
            <el-form-item>
                <el-radio style="position: relative;left: 20px" v-model="type" label="systemAdmin">系统管理员</el-radio>
                <el-radio style="position: relative;left: 20px" v-model="type" label="dormitoryAdmin">宿舍管理员</el-radio>
                <el-radio style="position: relative;left: 30px" v-model="type" label="dormitoryAdmin">学生</el-radio>
            </el-form-item>
