<template>
    <div class="login-container" :style="{backgroundImage:backImg }">
        <el-form :model="ruleForm" :rules="rules"
            ...
            <h3 class="title" style="text-align: center;">学生宿舍管理系统登录</h3>
            ...
            <el-form-item>
                ...
                <el-radio style="position: relative;" v-model="type" label="dormitoryAdmin">宿舍管理员</el-radio>
                <el-radio style="position: relative;" v-model="type" label="student">学生</el-radio>
            </el-form-item>
...
<script>
    import backImg from "public/photo/background.jpg"
    export default {
        name: "Login",
        data(){
            return{
                backImg:"url("+require("../../../../public/photo/background.jpg")+")",
                logining: false,
                ruleForm: {
                ...
                this.$refs.ruleForm.validate((valid) => {
                    if(valid){
                        ...
                        if(_this.type == 'dormitoryAdmin'){
                            axios.get('http://localhost:8181/dManager/login', {params:_this.ruleForm}).then(function (resp) {
                        ...
                        if(_this.type == 'student'){
                            axios.get('http://localhost:8181/student/login', {params:_this.ruleForm}).then(function (resp) {
                                _this.logining = false
                                if(resp.data.code == -1){
                                    _this.$alert('用户名不存在', '提示', {
                                        confirmButtonText: '确定'
