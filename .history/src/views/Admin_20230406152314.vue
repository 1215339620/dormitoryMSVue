            ...
            <el-aside class="home_aside" width="200px">
                ...
                <el-menu router>
                    <el-submenu index="1">
                        ...
                        <el-menu-item index="/buildingAdd" :class="$route.path=='/dormitoryAdminAdd'?'is-active':''">
                            <i class="el-icon-folder-add"></i>添加楼宇
                        </el-menu-item>
                        <el-menu-item index="/buildingManager" :class="$route.path=='/dormitoryAdminAdd'?'is-active':''">
                            <i class="el-icon-document-copy"></i>楼宇管理
                        </el-menu-item>
                    </el-submenu>
                    <el-submenu index="2">
                        <template slot="title"><i class="el-icon-s-home"></i>宿舍模块</template>
                        <el-menu-item index="/dormitoryAdd" :class="$route.path=='/dormitoryAdminAdd'?'is-active':''">
                            <i class="el-icon-folder-add"></i>添加宿舍
                        </el-menu-item>
                        <el-menu-item index="/dormitoryManager" :class="$route.path=='/dormitoryAdminAdd'?'is-active':''">
                    ...
                    <el-submenu index="4">
                        ...
                        <el-menu-item index="/studentManager" :class="$route.path=='/dormitoryAdminAdd'?'is-active':''">
                            <i class="el-icon-document-copy"></i>学生管理
                        </el-menu-item>
                    </el-submenu>
                    <el-menu-item index="/moveoutRegister" :class="$route.path=='/dormitoryAdminAdd'?'is-active':''">
                        <i class="el-icon-s-unfold"></i>
                        <span slot="title">学生迁出登记</span>
                    </el-menu-item>

                    <el-menu-item index="/moveoutRecord" :class="$route.path=='/dormitoryAdminAdd'?'is-active':''">
