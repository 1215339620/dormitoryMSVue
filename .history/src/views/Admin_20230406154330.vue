        ...
        <el-container>
            ...
            <el-aside class="home_aside" width="200px">
                ...
                <el-menu router>
                    ...
                    <el-menu-item index="/absentRecord" :class="$route.path=='/repairRecord'?'is-active':''">
                        <i class="el-icon-s-order"></i>
                    ...
                    <el-submenu index="6">
                        ...
                        <el-menu-item index="/personalInformation" :class="$route.path=='/personalInformation'?'is-active':''">
                            <i class="el-icon-folder-add"></i>个人信息
                        </el-menu-item>
                        <el-menu-item index="/changePassword" :class="$route.path=='/changePassword'?'is-active':''">
