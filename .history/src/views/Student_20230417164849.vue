  ...
  <el-container class="home_container">
    ...
    <el-container>
      <el-aside class="home_aside" width="200px">
        <el-menu router>
          <el-menu-item
            index="/noticeManager2"
            :class="$route.path == '/noticeManager2' ? 'is-active' : ''"
          >
          ...
          <el-menu-item
            index="/repairRecord3"
            :class="$route.path == '/repairRecord3' ? 'is-active' : ''"
          >
            <i class="el-icon-s-order"></i>
          ...
          <el-menu-item
            index="/changePasswordStudent"
            :class="$route.path == '/changePasswordStudent' ? 'is-active' : ''"
          >
