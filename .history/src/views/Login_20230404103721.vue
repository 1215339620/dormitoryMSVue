    ...
    <div class="login-container">
        <el-form :model="ruleForm" :rules="rules"
            ...
            <el-form-item>
                ...
                <el-radio style="position: relative;left: 30px" v-model="type" label="dormitoryAdmin">宿舍管理员</el-radio>
                <el-radio style="position: relative;left: 30px" v-model="type" label="dormitoryAdmin">xue's</el-radio>
            </el-form-item>
