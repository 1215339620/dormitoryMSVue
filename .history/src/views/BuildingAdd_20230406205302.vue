    ...
    <div style="margin-top: 60px;margin-left:330px;width: 300px;height: 500px;border: 0px solid red;" >
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="宿管姓名" prop="dManager">
                <el-input v-model="ruleForm.dManager"></el-input>
            </el-form-item>
            <el-form-item>
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    dManager: [
                        { required: true, message: '请选择宿管人员', trigger:'blur' }
                    ]
                }
            };
        },
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        axios.post('http://localhost:8181/bu'l/save',_this.ruleForm).then(function (resp) {
                            if(resp.data.code == 0){
